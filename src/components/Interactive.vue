...
const emits = defineEmits<{
  (e: "move", interaction: Interaction): void;
  (e: "key", offset: Interaction): void;
}>();
...
const handleMoveStart = (nativeEvent: MouseEvent | TouchEvent) => {
  ...
  el.focus();
  emits("move", getRelativePosition(el, nativeEvent, touchId.value));
...
const handleMove = (event: MouseEvent | TouchEvent) => {
  ...
  if (isDown && container.value) {
    emits("move", getRelativePosition(container.value, event, touchId.value));
  } else {
